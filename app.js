...
function generateExpectations(draft) {
  ...
  const unitSpecific = {
    ...
    yaklr:      'גיבוש תמונת מצב אמינה ורבת-מקורות (גדוד, מד"א, כב"א, משטרה, מוקד עירוני, רווחה, קב"ט — לא שמועות) והעברתה לקצין האוכלוסייה הנפתי. ניהול ימב"צ, תיאום סיוע הדדי בין רשויות ("חתירה למגע" מצד רשויות שלא נפגעו ישירות), תיאום מסרי הסברה מול מוקד 106, מענה לאוכלוסיות מיוחדות, וניהול ריבוי זירות ותעדוף בזמן אמת.',
